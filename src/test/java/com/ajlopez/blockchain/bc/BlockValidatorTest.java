...
public class BlockValidatorTest {
    ...
    public void validBlockWithTransaction() throws IOException {
        ...
        Block block = new Block(genesis.getNumber() + 1, genesis.getHash(), null, transactions, BlockExecutionResult.calculateTransactionReceiptsHash(transactionReceipts), accountStore.getRootHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), null, 0);
    ...
    public void invalidBlockWithInvalidTransactionsRoot() {
        ...
        Block block0 = new Block(1, FactoryHelper.createRandomBlockHash(), null, transactions, null, FactoryHelper.createRandomHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), null, 0);
    ...
    public void cannotBuildBlockWithInvalidTransaction() throws IOException {
        ...
        new Block(genesis.getNumber() + 1, genesis.getHash(), null, transactions, BlockExecutionResult.calculateTransactionReceiptsHash(transactionReceipts), genesis.getStateRootHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), Difficulty.ONE, 0);
    }
    ...
    public void invalidEmptyBlock() throws IOException {
        CodeStore codeStore = new CodeStore(new HashMapStore());
        Block genesis = GenesisGenerator.generateGenesis();
        Block block = new Block(genesis.getNumber() + 1, genesis.getHash(), null, new ArrayList<>(), null, FactoryHelper.createRandomHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), null, 0);
