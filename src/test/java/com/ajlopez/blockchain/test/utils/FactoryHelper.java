...
public class FactoryHelper {
    ...
    public static BlockHeader createBlockHeader(long blockNumber) {
        ...
        return new BlockHeader(blockNumber, hash, 0, transactionsHash, null, 0, null, stateRootHash, System.currentTimeMillis() / 1000, coinbase, difficulty, 12_000_000L, 0, null, 0);
    }
