...
public class MessageProcessorTest {
    ...
    public void processOrphanBlockMessageAndSendGetBlockByHashToSender() throws IOException {
        ...
        Block block1 = new Block(1, blockChain.getBestBlockInformation().getBlockHash(), null, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0);
        Block block2 = new Block(2, block1.getHash(), null, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0);
