...
public class MinerProcessorTest {
    ...
    public void mineBlockWithOneTransaction() throws IOException {
        ...
        Block parent = new Block(1L, hash, null, accountStore.getRootHash(), System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0, 0);
    ...
    public void mineBlockWithOneTransactionExecutingCodeAccesingBlockData() throws IOException {
        ...
        Block parent = new Block(41L, hash, null, accountStore.getRootHash(), System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0, 0);
