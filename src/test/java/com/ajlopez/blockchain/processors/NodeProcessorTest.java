...
public class NodeProcessorTest {
    ...
    public void createWithPeer() {
        ...
        NodeProcessor nodeProcessor = new NodeProcessor(new NetworkConfiguration((short)42), peer, blockChain, null, null, coinbase);
    ...
    public void getStatus() {
        ...
        NodeProcessor nodeProcessor = new NodeProcessor(networkConfiguration, peer, blockChain, null, null, coinbase);
