...
public class NodeProcessorTest {
    ...
    public void processBlockMessage() throws InterruptedException, IOException {
        ...
        Block block = new Block(1, blockChain.getBestBlockInformation().getBlockHash(), MerkleTree.EMPTY_MERKLE_TREE_HASH, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0, 0);
    ...
    public void processTenRepeatedBlockMessages() throws InterruptedException, IOException {
        ...
        Block block = new Block(1, blockChain.getBlockByNumber(0).getHash(), MerkleTree.EMPTY_MERKLE_TREE_HASH, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE, 0, 0);
    ...
    public void processTwoConsecutiveBlockMessages() throws InterruptedException, IOException {
        ...
        Block block1 = new Block(1, blockChain.getBlockByNumber(0).getHash(), MerkleTree.EMPTY_MERKLE_TREE_HASH, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, Address.ZERO, Difficulty.ONE, 0, 0);
    ...
    public void processTwoBlockMessagesUsingTwoNodes() throws InterruptedException, IOException {
        ...
        Block genesis = new Block(0, null, MerkleTree.EMPTY_MERKLE_TREE_HASH, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, Address.ZERO, Difficulty.ONE, 0, 0);
