...
public class BlockProcessorTest {
    ...
    public void rejectBlockByInvalidTransactionRoot() throws IOException {
        ...
        Block block0 = new Block(0, null, null, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE);
    ...
    public void addOrphanBlock() throws IOException {
        ...
        Block block = new Block(1, null, null, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE);
    ...
    public void switchToABetterForkUsingOrphan() throws IOException {
        ...
        Block block3 = new Block(3, block2.getHash(), MerkleTree.EMPTY_MERKLE_TREE_HASH, Trie.EMPTY_TRIE_HASH, System.currentTimeMillis() / 1000, coinbase, Difficulty.ONE);
