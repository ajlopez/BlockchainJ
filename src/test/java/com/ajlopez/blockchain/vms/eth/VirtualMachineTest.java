...
public class VirtualMachineTest {
    ...
    public void executeStorageStoreWithoutEnoughGas() throws IOException {
        ...
        VirtualMachine virtualMachine = createVirtualMachine(FeeSchedule.VERYLOW.getValue() * 2 + FeeSchedule.SSET.getValue() / 2, storage);
    ...
    public void cannotExecuteStorageStoreIfMessageIsReadOnly() throws IOException {
        Storage storage = new MapStorage();
        MessageData messageData = new MessageData(FactoryHelper.createRandomAddress(), null, null, null, Coin.ZERO, 100000, Coin.ZERO, null, 0, 0, false, true);
    ...
    public void executeGasPriceOperations() throws IOException {
        ...
        MessageData messageData = new MessageData(null, null, null, null, Coin.ONE, 100000, gasPrice, null, 0, 0, false, false);
    ...
    public void executeAddressOriginCallerCallValueOperations() throws IOException {
        ...
        MessageData messageData = new MessageData(address, origin, caller, null, Coin.ONE, 100000, null, null, 0, 0, false, false);
    ...
    public void executeCallDataSize() throws IOException {
        ...
        MessageData messageData = new MessageData(null, null, null, null, Coin.ONE, 100000, null, data, 0, 0, false, false);
    ...
    public void executeCodeCopy() throws IOException {
        ...
        MessageData messageData = new MessageData(null, null, null, null, Coin.ONE, 100000, null, null, 0, 0, false, false);
    ...
    public void executeCoinbaseTimestampNumberDifficultyOperations() throws IOException {
        ...
        VirtualMachine virtualMachine = createVirtualMachine(blockData);
    ...
    public void executeChainId() throws IOException {
        BlockData blockData = new BlockData(0, 0, null, null, 0, 42);
        VirtualMachine virtualMachine = createVirtualMachine(blockData);
    ...
    public void executeWithInsufficientGasRaiseException() throws IOException {
        MessageData messageData = new MessageData(null, null, null, null, Coin.ZERO, 0, Coin.ZERO, null, 0, 0, false, false);
        VirtualMachine virtualMachine = new VirtualMachine(null, messageData, null, null);
    ...
    private static VirtualMachine createVirtualMachine() {
        return createVirtualMachine(100000);        
    }
    
    private static VirtualMachine createVirtualMachine(long gas) {
        MessageData messageData = new MessageData(FactoryHelper.createRandomAddress(), null, null, null, Coin.ZERO, gas, Coin.ZERO, null, 0, 0, false, false);
        
        return createVirtualMachine(messageData, null, null);
    }

    private static VirtualMachine createVirtualMachine(BlockData blockData) {
        MessageData messageData = new MessageData(FactoryHelper.createRandomAddress(), null, null, null, Coin.ZERO, 100000, Coin.ZERO, null, 0, 0, false, false);
    ...
    private static VirtualMachine createVirtualMachine(Address address, ExecutionContext executionContext) {
        MessageData messageData = new MessageData(address, null, null, null, Coin.ZERO, 100000, Coin.ZERO, null, 0, 0, false, false);

        return createVirtualMachine(messageData, executionContext, null);
    }

    private static VirtualMachine createVirtualMachine(MessageData messageData, ExecutionContext executionContext, Storage storage) {
        return new VirtualMachine(null, messageData, executionContext, storage);
    }
    
    private static Address createAccountWithBalance(AccountStore accountStore, long balance) throws IOException {
