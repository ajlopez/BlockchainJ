...
/**
 * Created by ajlopez on 26/11/2020.
 */
public class VirtualMachineStaticCallTest {
    @Test
    public void executeStaticCallReturningCaller() throws IOException {
    ...
    @Test
    public void executeStaticCallWithInvalidGas() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.CALLER,
                OpCodes.PUSH1, 0,
                OpCodes.MSTORE,
    ...
    @Test
    public void executeStaticCallReturningOriginalSender() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.ORIGIN,
                OpCodes.PUSH1, 0,
                OpCodes.MSTORE,
    ...
    @Test
    public void executeStaticCallReturningReceiver() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.ADDRESS,
                OpCodes.PUSH1, 0,
                OpCodes.MSTORE,
    ...
    @Test
    public void executeStaticCallThatReverts() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
                OpCodes.PUSH1, 0,
                OpCodes.REVERT
    ...
    @Test
    public void executeStaticCallIncrementingInputData() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
    ...
    @Test
    public void executeStaticCallSavingInputDataIntoStorageFails() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
                OpCodes.CALLDATALOAD,
                OpCodes.PUSH1, 0,
    ...
    @Test
    public void executeStaticCallSavingInputDataIntoStorageAndRevert() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
                OpCodes.CALLDATALOAD,
                OpCodes.PUSH1, 0,
    ...
    @Test
    public void executeStaticCallThatReturnsTooMuchData() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
                OpCodes.CALLDATALOAD,
                OpCodes.PUSH1, 1,
    ...
    @Test
    public void executeStaticCallThatReturnsLessDataThanExpected() throws IOException {
        byte[] calleeCode = new byte[]{
                OpCodes.PUSH1, 0,
                OpCodes.CALLDATALOAD,
                OpCodes.PUSH1, 1,
