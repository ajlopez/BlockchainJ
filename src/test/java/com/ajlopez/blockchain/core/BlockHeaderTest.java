...
public class BlockHeaderTest {
    ...
    public void createWithNumberAndParentHash() {
        ...
        BlockHeader header = new BlockHeader(1L, hash, 42, transactionsHash, stateRootHash, System.currentTimeMillis() / 1000, coinbase, difficulty);
    ...
    public void equals() {
        ...
        BlockHeader header = new BlockHeader(1L, hash, 0, transactionsHash, stateRootHash, 1L, coinbase, difficulty);
        BlockHeader header2 = new BlockHeader(1L, hash, 0, transactionsHash, stateRootHash, 1L, coinbase, difficulty);
        BlockHeader header3 = new BlockHeader(1L, hash, 0, transactionsHash, stateRootHash, 2L, coinbase, difficulty);
    ...
    public void twoDifferentHeadersHaveDifferentHashes() {
        BlockHeader header1 = new BlockHeader(1L, FactoryHelper.createRandomBlockHash(), 0, FactoryHelper.createRandomHash(), FactoryHelper.createRandomHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), Difficulty.fromUnsignedLong(42));
        BlockHeader header2 = new BlockHeader(2L, FactoryHelper.createRandomBlockHash(), 0, FactoryHelper.createRandomHash(), FactoryHelper.createRandomHash(), System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), Difficulty.fromUnsignedLong(42));
    ...
    public void negativeNumber() {
        ...
        new BlockHeader(-1L, hash, 0, transactionsHash, stateRootHash, System.currentTimeMillis() / 1000, FactoryHelper.createRandomAddress(), null);
    }
}
